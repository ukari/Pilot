...
namespace Pilot
{
    ...
    class PUnderSamplingAliasingPass : public PRenderPassBase
    {
    public:
    ...
    enum
    {
        ...
        _main_camera_subpass_undersampling_aliasing,
    ...
    public:
        ...
        void draw(PUnderSamplingAliasingPass& undersampling_aliasing_pass,
