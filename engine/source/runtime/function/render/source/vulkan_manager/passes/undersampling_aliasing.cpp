...
#include <undersampling_aliasing_frag.h>

namespace Pilot
{
    void PUnderSamplingAliasingPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PUnderSamplingAliasingPass::setupDescriptorSetLayout()
    {
    ...
    void PUnderSamplingAliasingPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, UNDERSAMPLING_ALIASING_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_undersampling_aliasing;
    ...
    void PUnderSamplingAliasingPass::setupDescriptorSet()
    {
    ...
    void PUnderSamplingAliasingPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PUnderSamplingAliasingPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "UnderSampling Aliasing", {1.0f, 1.0f, 1.0f, 1.0f}};
