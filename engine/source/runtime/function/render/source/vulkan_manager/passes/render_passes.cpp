...
bool Pilot::PVulkanManager::initializeRenderPass()
{
    ...
    m_undersampling_aliasing_pass.initialize(m_main_camera_pass.getRenderPass(), m_main_camera_pass.getFramebufferImageViews()[_main_camera_pass_backup_buffer_odd]);
